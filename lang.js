...
const translations = {
  en: {
    ...
    "srv1-text": "Responsive websites built with HTML, CSS, JS or React.js",
    ...
    "srv5-text": "Whether we're talking about Excel files or SQL databases, we can help you store and process your data",
    "srv6-title": "Other",
    ...
    "portfolio-title": "Highlighted Projects - Click on the cards for more details",
    "proj1-title": "Excome",
    ...
    "proj5-title":"Video Games",
    "proj5-text":"Simple and enjoyable Unity-based video games, perfect for passing the time when you're feeling bored.",
    "proj6-title":"Akee",
    "proj6-text":"Website developed for a young, talented music producer.",
  ...
  ro: {
    ...
    "srv1-text": "Site-uri web responsive construite cu HTML, CSS, JS sau React.js",
    ...
    "srv5-text": "Fie că vorbim de fișiere Excel sau baze de date SQL, te ajutăm să-ți gestionezi si procesezi datele",
    "srv6-title": "Altele",
    "srv6-text": "Algoritmi, secțiuni de proiect la care ai nevoie de ajutor... spune-ne și noi te ajutam",
    "proj6-title":"Akee",
    "proj6-text":"Website dezvoltat pentru un tânăr producător muzical talentat.",
    ...
    "portfolio-title": "Proiecte reprezentative  – Fă clic pe carduri pentru mai multe detalii",
    "proj1-title": "Excome",
    ...
    "proj5-title":"Jocuri Video",
    "proj5-text":"Jocuri video simple și distractive dezvoltate în Unity, ideale pentru momentele de relaxare sau când te plictisești.",
    "contact-title": "Contact",
    "about-title": "Despre mine",
  ...
  de: {
    ...
    "srv1-text": "Responsive Websites erstellt mit HTML, CSS, JS oder React.js",
    "srv2-title": "Logo-Design",
    ...
    "portfolio-title": "Ausgewählte Schlüsselprojekte – Klicke auf die Karten für mehr Details",
    "proj1-title": "Excome",
    ...
    "proj3-title": "Logos",
    "proj3-text": "Entdecke eine Sammlung von Logos, die mit Sorgfalt und Kreativität gestaltet wurden.",
    ...
    "proj5-title":"Videospiele",
    "proj5-text":"Einfacher und unterhaltsamer Videospiele, entwickelt mit Unity – perfekt für entspannte Momente oder wenn dir langweilig ist.",
    "proj6-title":"Akee",
    "proj6-text":"Website entwickelt für einen jungen, talentierten Musikproduzenten.",
